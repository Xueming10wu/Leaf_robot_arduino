...
void ManipulatorProtocol::manipulatorInit(int degrees)
{
    ...
    readManipulator.stepMotorList = new StepMotor[degrees];
    writeManipulator.stepMotorList = new StepMotor[degrees];
    for (size_t i = 0; i < degrees; i ++)
    {
        readManipulator.stepMotorList[i] = stepmotor;
        writeManipulator.stepMotorList[i] = stepmotor;
    }
